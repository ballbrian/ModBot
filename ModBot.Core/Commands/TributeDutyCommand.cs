...
{
    [Group("tributes")]
    public class TributeDutyCommandSet : ModuleBase<SocketCommandContext>, IModCommandSet
    {
        private readonly ICommandReplyService _commandReplyService;

        public ModType ModType => ModType.Tributes;

        public TributeDutyCommandSet(ICommandReplyService commandReplyService)
        {
