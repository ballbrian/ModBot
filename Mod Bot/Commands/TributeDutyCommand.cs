...
{
    [Group("tributes")]
    public class TributeDutyCommand : ModuleBase<SocketCommandContext>, IModCommand
    {
        private readonly IRoleService _roleService;

        protected ModType ModType => ModType.Tributes;

        public TributeDutyCommand(IRoleService roleService)
        {
